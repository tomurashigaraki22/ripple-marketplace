...
export default function WalletPage() {
  ...
  const wallets2 = [
    ...
    },
    {
      ...
      connected: phantomConnected,
      connectFn: null, // Handled by WalletMultiButton
      disconnectFn: phantomDisconnect,
      connecting: phantomConnecting,
  ...
  return (
    <div className="min-h-screen py-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
                    ...
                    <div className="flex items-center justify-between mb-4">
                      <div className="flex items-center space-x-4">
                        ...
                        <div>
                          ...
                          {wallet.balance !== null && (
                            <p className="text-sm text-[#39FF14]">Balance: {wallet.balance.toFixed(4)} SOL</p>
                          )}
                        </div>
                      </div>
                      <button
              ...
              <div className="text-center">
                ...
                {wallet.connected ? (
                  <div className="space-y-4">
                    ...
                    {wallet.name === "Phantom" ? (
                      <WalletDisconnectButton className="!w-full !bg-red-500/20 !border !border-red-500/50 !text-red-400 !rounded-xl !font-medium !px-6 !py-3 hover:!bg-red-500/30 !transition-all !duration-300" />
                    ) : (
                      <button
                        onClick={() => handleDisconnect(wallet)}
                        disabled={isLoading}
        ...
        {/* Getting Started section, Security Notice, etc. */}
      </div>
    </div>
  )
}
